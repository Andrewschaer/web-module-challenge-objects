...
console.log('task 1a', createMenuItem('pizza pie', '1BTC', 'anytime'));
...
console.log('task 1b', createMenuItem('pizza pie', 20, 'dinner'));
console.log('task 1b', createMenuItem('grilled cheese', 6, 'lunch'));
console.log('task 1b', createMenuItem('bagel with schmear', 4, 'breakfast'));
...
*/
reviews.push({name: "Egg", rating: 5, feedback: "I'm a dog - ruff ruff ruff ruff a woo woo woo!"});
